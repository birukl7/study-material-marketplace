...
<main class="mt-10">
        ...
        <div class=" w-1/2 flex flex-col justify-center p-3 pl-8">
            ...
            <div class="mt-10">
                <a href="{{ url('/resources/create')}}">
                    <button
                        class="outline outline-1 rounded-full py-2 px-6 mr-3 text-white bg-black hover:shadow-xl transition-all duration-500 ease-in-out">Sell
                        Materials</button>
                </a>

                <button
                    class="outline outline-1 rounded-full py-2 px-6 hover:px-8 transition-all duration-500 ease-in-out"><a
                        href="#materials">Purchase Material</a></button>
            </div>
        </div>
    ...
    <section id="materials" class="pt-20">
        <div class=" mt-10">
            ...
            <p class="text-center p-5 text-xl  w-8/12 my-0 mx-auto">Learning often happens in classrooms but it doesn't
                have to. use CourseMaterial to crack those final questions.</p>
        </div>
        <div id="card-main-container "
            class="grid grid-cols-4 gap-5 p-3 bg-slate  js-container h-material  overflow-hidden pt-2 transition-all duration-1000 ease-in-out">
        ...
        <div class="flex justify-center mt-5">
            <button class="outline outline-1 p-2 rounded-full  transition-all duration-500 ease-in-out px-8 hover:px-10"
                id="browse-btn"> Browse All Materials</button>
        </div>
