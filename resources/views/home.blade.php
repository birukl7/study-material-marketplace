...
<main class="mt-10">
    ...
    <section id="materials" class="pt-20">
        ...
        <div id="card-main-container " class="grid grid-cols-4 gap-5 p-3 bg-green-500 js-container h-material  overflow-hidden pt-2 transition-all duration-1000 ease-in-out">
